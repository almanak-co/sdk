...
def test_call_strategy_action_rest_200_returns_json_body() -> None:
    ...
    # Auth header is preserved verbatim - see issue #1711 (fix deferred).
    assert call.kwargs["headers"]["X-API-Key"] == "demo-key"
    assert call.kwargs["json"] == {"gas_price_gwei": 3.5}


def test_call_strategy_action_rest_400_includes_detail() -> None:
...
def test_call_strategy_action_rest_404_uses_strategy_id_in_error() -> None:
...
def test_call_strategy_action_rest_500_generic_error() -> None:
...
def test_call_strategy_action_rest_connection_error_sets_flag() -> None:
...
def test_call_strategy_action_rest_timeout_no_connection_flag() -> None:
...
def test_call_strategy_action_rest_unexpected_exception() -> None:
