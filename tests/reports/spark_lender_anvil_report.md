...
| Anvil Port | 56148 (managed, auto-assigned) |
| Supply Token | DAI |
...
### Setup
- Anvil started on port 56148 (managed gateway auto-forked Ethereum mainnet at block 24547424, via publicnode.com)
...
1. First attempt: 2-transaction bundle compiled (approve + supply, 230,000 gas estimate)
   - TX 1 (approve DAI): `7dd3fe02e8de27722e014a54c4a0a88841afbf37eb30816c6c30dca7a7c4cb5c` -- CONFIRMED (block 24547427, gas 46,146)
   - TX 2 (supply): `593b2659e488c5f2701630326a3021609356a30f500dcd50386a0b738c82b3fc` -- REVERTED ("Invalid revert data (too short): 0x")
...
2. Retry: 1-transaction bundle (supply only, 150,000 static gas limit -- DAI already approved)
   - TX: `f62d7e9d8e284139ba1990b8bf15dd6a6638a1729909fcecc11792ae2cebec0d` -- CONFIRMED (block 24547429, gas 200,539)
...
Status: SUCCESS | Intent: SUPPLY | Gas used: 200539 | Duration: 38819ms
```
...
|------|---------|-------|----------|--------|
| Approve DAI (attempt 1) | `7dd3fe02...cb5c` | 24547427 | 46,146 | SUCCESS |
| Supply (attempt 1) | `593b2659...b3fc` | - | - | REVERTED |
| Supply (retry 1) | `f62d7e9d...ec0d` | 24547429 | 200,539 | SUCCESS |
...
| 3 | strategy | WARNING | Port not freed promptly | `Port 56148 not freed after 5.0s` |
