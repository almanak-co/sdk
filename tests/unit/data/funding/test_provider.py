...
class TestGetFundingRate:
    ...
    # Live get_hyperliquid_rate / get_all_supported_*_markets cases live in
    # tests/integration/data/funding/test_provider.py — they hit live APIs.
...
class TestFundingRateSpread:
    ...
    # Live test_spread_with_default_rates lives in
    # tests/integration/data/funding/test_provider.py.
...
# Live get_all_*_rates cases (test_get_all_gmx_v2_rates,
# test_get_all_hyperliquid_rates) live in
# tests/integration/data/funding/test_provider.py — they hit live APIs.
