...
class TestQARunner:
    ...
    async def test_run_all_orchestrates_tests(
        ...
        with (
            patch("almanak.framework.data.qa.runner.CEXSpotPriceTest") as mock_cex_spot,
            patch("almanak.framework.data.qa.runner.DEXSpotPriceTest") as mock_dex_spot,
            patch("almanak.framework.data.qa.runner.CEXHistoricalTest") as mock_cex_hist,
            patch("almanak.framework.data.qa.runner.DEXHistoricalTest") as mock_dex_hist,
            patch("almanak.framework.data.qa.runner.RSITest") as mock_rsi,
        ):
            # Configure mocks
    ...
    async def test_generate_plots_called_when_enabled(
        ...
        with (
            ...
            patch("almanak.framework.data.qa.runner.DEXHistoricalTest") as mock_dex_hist,
            patch("almanak.framework.data.qa.runner.RSITest") as mock_rsi,
            patch("almanak.framework.data.qa.runner.PlotGenerator") as mock_plot_gen,
        ):
