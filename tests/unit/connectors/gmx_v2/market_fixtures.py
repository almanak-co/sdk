"""Verified-market fixtures for GMX V2 tests (address-first migration).

Literal snapshot of the last on-chain-audited market catalogue (every row was
verified against ``Reader.getMarket`` by ``tests/audit/test_gmx_v2_market_identity.py``
while the production ``GMX_V2_MARKETS`` table still existed). Production code
no longer ships a symbol→address table — strategies supply addresses and the
dynamic registry verifies them — so tests that need "a verified market" prime
the process catalog from these rows instead of patching a production table.
...
FIXTURE_MARKETS: tuple[tuple[str, ResolvedGmxMarket], ...] = (
    _row("arbitrum", "AAVE/USD", "0x1CbBa6346F110c8A5ea739ef2d1eb182990e4EB2", "0xba5DdD1f9d7F570dc94a51479a000E3BCE967196", "AAVE", 18, "AAVE", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "ARB/USD", "0xC25cEf6061Cf5dE5eb761b50E4743c1F5D7E5407", "0x912CE59144191C1204E64559FE8253a0e49E6548", "ARB", 18, "ARB", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "ATOM/USD", "0x248C35760068cE009a13076D573ed3497A47bCD4", "0x7D7F1765aCbaF847b9A1f7137FE8Ed4931FbfEbA", "ATOM", 6, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "AVAX/USD", "0x7BbBf946883a5701350007320F525c5379B8178A", "0x565609fAF65B92F7be02468acF86f8979423e514", "AVAX", 18, "WAVAX", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "BTC/USD", "0x47c031236e19d024b42f8AE6780E44A573170703", "0x47904963fc8b2340414262125aF798B9655E58Cd", "BTC", 8, "WBTC", "0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "DOGE/USD", "0x6853EA96FF216fAb11D2d930CE3C508556A4bdc4", "0xC4da4c24fd591125c3F47b340b6f4f76111883d8", "DOGE", 8, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "ETH/USD", "0x70d95587d40A2caf56bd97485aB3Eec10Bee6336", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "ETH", 18, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "GMX/USD", "0x55391D178Ce46e7AC8eaAEa50A72D1A5a8A622Da", "0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a", "GMX", 18, "GMX", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "LINK/USD", "0x7f1fa204bb700853D36994DA19F830b6Ad18455C", "0xf97f4df75117a78c1A5a0DBb814Af92458539FB4", "LINK", 18, "LINK", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "LTC/USD", "0xD9535bB5f58A1a75032416F2dFe7880C30575a41", "0xB46A094Bc4B0adBD801E14b9DB95e05E28962764", "LTC", 8, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "NEAR/USD", "0x63Dc80EE90F26363B3FCD609007CC9e14c8991BE", "0x1FF7F3EFBb9481Cbd7db4F932cBCD4467144237C", "NEAR", 24, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "OP/USD", "0x4fDd333FF9cA409df583f306B6F5a7fFdE790739", "0xaC800FD6159c2a2CB8fC31EF74621eB430287a5A", "OP", 18, "OP", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "SOL/USD", "0x09400D9DB990D5ed3f35D7be61DfAEB900Af03C9", "0x2bcC6D6CdBbDC0a4071e48bb3B969b06B3330c07", "SOL", 9, "SOL", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "UNI/USD", "0xc7Abb2C5f3BF3CEB389dF0Eecd6120D451170B50", "0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0", "UNI", 18, "UNI", "", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("arbitrum", "XRP/USD", "0x0CCB4fAa6f1F1B30911619f1184082aB4E25813c", "0xc14e065b0067dE91534e032868f5Ac6ecf2c6868", "XRP", 6, "WETH", "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "USDC", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"),
    _row("avalanche", "AVAX/USD", "0x913C1F46b48b3eD35E7dc3Cf754d4ae8499F31CF", "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7", "AVAX", 18, "WAVAX", "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7", "USDC", "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"),
    _row("avalanche", "BTC/USD", "0xFb02132333A79C8B5Bd0b64E3AbccA5f7fAf2937", "0x152b9d0FdC40C096757F570A51E494bd4b943E50", "BTC", 8, "BTC.b", "0x152b9d0FdC40C096757F570A51E494bd4b943E50", "USDC", "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"),
    _row("avalanche", "ETH/USD", "0xB7e69749E3d2EDd90ea59A4932EFEa2D41E245d7", "0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB", "ETH", 18, "WETH.e", "0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB", "USDC", "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"),
    _row("avalanche", "LTC/USD", "0xA74586743249243D3b77335E15FE768bA8E1Ec5A", "0x8E9C35235C38C44b5a53B56A41eaf6dB9a430cD6", "LTC", 8, "WAVAX", "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7", "USDC", "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"),
    _row("avalanche", "SOL/USD", "0xd2eFd1eA687CD78c41ac262B3Bc9B53889ff1F70", "0xFE6B19286885a4F7F55AdAD09C3Cd1f906D2478F", "SOL", 9, "SOL", "", "USDC", "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"),
)
...
def fake_dynamic_gateway(
    chain: str, *records: ResolvedGmxMarket, rpc_url: str | None = None
) -> SimpleNamespace:
