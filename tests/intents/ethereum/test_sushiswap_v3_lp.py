"""Production-grade LP Intent tests for SushiSwap V3 on Ethereum.
...
To run:
    uv run pytest tests/intents/ethereum/test_sushiswap_v3_lp.py -v -s
"""
...
class TestSushiSwapV3CollectFeesIntent:
    """SushiSwap V3 LP_COLLECT_FEES on Ethereum (4-layer Intent flow).
