"""Fixtures for Ethereum intent tests.
...
def _seed_wallet_state(web3: Web3, rpc_url: str) -> str:
    ...
    # On Ethereum mainnet, Anvil's default accounts (0xf39Fd...) have delegation
    # code that forwards received ETH, causing V4 swaps and other interactions
...
def anvil_rpc_url(anvil_ethereum: AnvilFixture) -> str:
    ...
    return f"http://127.0.0.1:{anvil_ethereum.port}"


@pytest.fixture(scope="module")
def web3(anvil_rpc_url: str) -> Web3:
    """Connect to gateway's Anvil fork for Ethereum."""
