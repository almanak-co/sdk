"""Ethereum Zodiac negative-authorisation anchor.

Per-chain "negative anchor" companion to the regular intent tests under
``tests/intents/ethereum/``. The default-on Zodiac model wired up in
...
every other chain, including ethereum.

This anchor closes the gap on ethereum by parametrizing the canonical
