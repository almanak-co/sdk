"""Atomic, sealable Trader Joe V2 SWAP proofs on Ethereum.

Liquidity Book addresses a pair by (tokenX, tokenY, binStep), so the cell trades
the one USDT/USDC pair the connector's registry declares for this chain at bin
step 1; the venue and its size live in ``TRADERJOE_VENUES``.
"""
