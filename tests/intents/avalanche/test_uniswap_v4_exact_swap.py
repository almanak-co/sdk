"""Atomic, sealable Uniswap V4 SWAP proofs on Avalanche.
...
``v4_swap.v1``. Fee 3000 is pinned because it is the deepest initialised
USDC/WETH pool of that shape on avalanche (liquidity 3.15e15 against 2.67e12 at fee 500); the pin travels into
