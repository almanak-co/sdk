"""Atomic, sealable Uniswap V3 SWAP proofs on Avalanche.

USDC/WAVAX is the liquid Uniswap V3 pair here. The USDC/WETH.e pool quotes a
2.2% price impact on the 10 USDC proof size -- above the 2% ceiling the exact
node enforces -- so it cannot carry a swap proof.
"""
...
CHAIN = "avalanche"
_SWAP = {"from_symbol": "USDC", "to_symbol": "WAVAX"}
_REVERSE = {"from_symbol": "WAVAX", "to_symbol": "USDC"}
