"""Production-grade LP Intent tests for SushiSwap V3 on Avalanche.
...
To run:
    uv run pytest tests/intents/avalanche/test_sushiswap_v3_lp.py -v -s
"""
...
class TestSushiSwapV3LPOpenIntent:
    ...
    async def test_lp_open_wavax_usdc(
        ...
        print(f"\n{'=' * 80}")
        print("Test: LP Open WAVAX/USDC via LPOpenIntent (SushiSwap V3)")
        print(f"{'=' * 80}")
        print(f"Pool: {POOL}")
