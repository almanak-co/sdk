...
def _seed_wallet_state(web3: Web3, rpc_url: str) -> str:
    """Seed test wallet balances for Avalanche on the current fork instance."""
...
def anvil_instance(anvil_avalanche: AnvilFixture) -> AnvilFixture:
    """Expose the chain-specific AnvilFixture for shared recovery logic."""
    return anvil_avalanche
