...
class TestSushiSwapV3SwapIntent:
    ...
    @pytest.mark.xfail(
        strict=True,
        reason="VIB-5972: sushiswap_v3 swap pool selection on optimism — quoter returns no amount or route emits no Swap event (as of 2026-05-12; re-pointed to VIB-5972 2026-07-24)",
    )
