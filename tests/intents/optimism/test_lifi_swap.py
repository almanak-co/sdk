"""Production-grade SwapIntent tests for LiFi on Optimism.
...
To run:
    uv run pytest tests/intents/optimism/test_lifi_swap.py -v -s
"""
...
@pytest.mark.swap
class TestLiFiSwap:
    """LiFi same-chain swaps using SwapIntent on Optimism."""
    ...
    async def test_swap_usdc_to_weth_using_intent(
        ...
        """USDC -> WETH swap via LiFi SwapIntent on Optimism."""
