"""Atomic, sealable Uniswap V4 SWAP proofs on Optimism.
...
USDC/WETH pool of that shape on optimism (liquidity 6.72e12, the only initialised pool of this shape); the pin travels into
