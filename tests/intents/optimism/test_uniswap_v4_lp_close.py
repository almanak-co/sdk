...
def _weth_usdc_pool_key():
    """The canonical WETH/USDC/500 V4 PoolKey on this chain (all-ERC-20).

    Mirrors ``LP_POOL = "WETH/USDC/500"`` (fee=500, tick_spacing=10).
    ...
    return PoolKey(currency0=tokens["WETH"], currency1=tokens["USDC"], fee=500, tick_spacing=10)
