...
class TestUniswapV3SwapIntent:
    ...
    async def test_swap_usdc_to_weth_using_intent(
        ...
        print(f"\n{'='*80}")
        print("Test: USDC -> WETH Swap via SwapIntent (Uniswap V3 on X-Layer)")
        print(f"{'='*80}")
    ...
    async def test_swap_weth_to_usdc_using_intent(
        ...
        print(f"\n{'='*80}")
        print("Test: WETH -> USDC Swap via SwapIntent (Uniswap V3 on X-Layer)")
        print(f"{'='*80}")
