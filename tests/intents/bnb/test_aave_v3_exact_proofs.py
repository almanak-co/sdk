"""Atomic, sealable Aave V3 lending proofs on BSC.

Collateral is WBNB; the borrowed/supplied asset is USDC. There is no wstETH
reserve in the BSC intent-test token table.
"""
