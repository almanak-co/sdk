"""Atomic, sealable Uniswap V3 SWAP proofs on BSC.

USDT/WBNB fee 500 is the liquid Uniswap V3 pair; there is no USDC/WETH pool.
"""
...
CHAIN = "bsc"
_SWAP = {"from_symbol": "USDT", "to_symbol": "WBNB"}
_REVERSE = {"from_symbol": "WBNB", "to_symbol": "USDT"}
