...
class TestLiFiSwap:
    ...
    @pytest.mark.xfail(
        strict=False,
        reason="VIB-4307: LiFi aggregator route flake on Anvil polygon fork — sub-route revert / rate-limit retry stall, needs 10/10 run validation per intent-tests rule #12 (as of 2026-05-13)",
    )
