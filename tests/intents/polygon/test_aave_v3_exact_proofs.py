"""Atomic, sealable Aave V3 lending proofs on Polygon.

Collateral is WETH; the supplied/borrowed asset is native USDC. Polygon's WETH
is a PoS-bridged UChildERC20Proxy, so the fork seeds it by storage slot rather
than by wrapping native MATIC.
"""
