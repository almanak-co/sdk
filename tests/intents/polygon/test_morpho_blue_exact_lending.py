"""Atomic, sealable Morpho Blue lending proofs on Polygon.

All four target Intents settle in USDC, the WBTC/USDC market's loan token;
the collateral asset is supplied in setup only. 0.1 WBTC of collateral against a
...
CHAIN = "polygon"
MARKET = "WBTC/USDC"
AMOUNTS = MorphoAmounts(collateral=Decimal("0.1"))
