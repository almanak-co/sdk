...
class TestMorphoBlueBorrowIntent:
    ...
    async def test_borrow_usdc_with_wbtc_collateral_using_intent(
        ...
        # Step 1 — supply the WBTC collateral (two-intent form, #2827: the
...
async def _setup_borrow(
    ...
    """Helper: supply WBTC collateral, then standalone-borrow USDC (two-intent form, #2827).
