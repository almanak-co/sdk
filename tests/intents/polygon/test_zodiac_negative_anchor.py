"""Polygon Zodiac negative-authorisation anchor.

Per-chain "negative anchor" companion to the regular intent tests under
``tests/intents/polygon/``. The default-on Zodiac model wired up in
...
every other chain, including polygon.

This anchor closes the gap on polygon by parametrizing the canonical
