"""4-layer intent tests for Uniswap V4 LP_OPEN on Base Anvil fork.

Tests the full Intent -> Compile -> Execute -> Parse -> Verify flow for
opening concentrated liquidity positions via V4 PositionManager on Base:
...
To run:
    uv run pytest tests/intents/base/test_uniswap_v4_lp_open.py -v -s
"""
...
# =============================================================================
# LPOpenIntent Tests -- Uniswap V4 on Base
# =============================================================================
...
class TestUniswapV4LPOpenIntent:
    """Test Uniswap V4 LP_OPEN using LPOpenIntent on Base.
    ...
    async def test_lp_open_weth_usdc(
        ...
        print(f"\n{'='*80}")
        print("Test: LP_OPEN WETH/USDC via Uniswap V4 on Base")
        print(f"{'='*80}")
