"""4-layer intent tests for Uniswap V4 LP_OPEN on Arbitrum Anvil fork.

Tests the full Intent -> Compile -> Execute -> Parse -> Verify flow for
opening concentrated liquidity positions via V4 PositionManager on Arbitrum:
...
To run:
    uv run pytest tests/intents/arbitrum/test_uniswap_v4_lp_open.py -v -s
"""
...
# =============================================================================
# LPOpenIntent Tests -- Uniswap V4 on Arbitrum
# =============================================================================
...
class TestUniswapV4LPOpenIntent:
    """Test Uniswap V4 LP_OPEN using LPOpenIntent on Arbitrum.
    ...
    async def test_lp_open_weth_usdc(
        ...
        print(f"\n{'='*80}")
        print("Test: LP_OPEN WETH/USDC via Uniswap V4 on Arbitrum")
        print(f"{'='*80}")
