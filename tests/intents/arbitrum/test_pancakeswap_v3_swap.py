"""Production-grade SwapIntent tests for PancakeSwap V3 on Arbitrum.
...
To run:
    uv run pytest tests/intents/arbitrum/test_pancakeswap_v3_swap.py -v -s
"""
...
class TestPancakeSwapV3SwapIntent:
    ...
    @pytest.mark.xfail(
        ...
        "arbitrum Anvil fork (long-standing flake, pre-dates the hygiene rule; as of "
