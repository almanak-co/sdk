...
# Whole-module marker — these tests are explicitly integration-level (live
# Hyperliquid + GMX APIs). The module-level docstring already says so; the
# marker just ensures `make test-unit` (which filters `-m "not integration"`)
# skips them.
