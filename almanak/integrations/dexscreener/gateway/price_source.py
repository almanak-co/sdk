"""Gateway-only DexScreener price source.
...
CHAIN_TO_DEXSCREENER_PLATFORM: Mapping[str, str] = MappingProxyType(integration_chain_map("dexscreener"))
...
class _LazyKnownTokenAddresses(dict[str, dict[str, str]]):
    ...
    def copy(self) -> dict[str, dict[str, str]]:
        self._ensure_built()
        return super().copy()
    ...
    def pop(self, key: str, *args: Any) -> dict[str, str]:
        self._ensure_built()
        return super().pop(key, *args)

    def popitem(self) -> tuple[str, dict[str, str]]:
        self._ensure_built()
        return super().popitem()

    def setdefault(self, key: str, default: dict[str, str] | None = None) -> dict[str, str]:
        self._ensure_built()
