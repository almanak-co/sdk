"""Gateway-only Binance API client.
...
class BinanceIntegration(BaseIntegration):
    ...
    async def get_ticker(self, symbol: str) -> dict[str, Any]:
        ...
        data = await self._fetch("/api/v3/ticker/24hr", params={"symbol": symbol})
    ...
    async def get_order_book(
        ...
        data = await self._fetch("/api/v3/depth", params={"symbol": symbol, "limit": limit})
    ...
    async def get_exchange_info(self, symbol: str | None = None) -> dict[str, Any]:
        ...
        data = await self._fetch("/api/v3/exchangeInfo", params=params)
