...
------
    # Run in dry-run mode
    almanak strat run -d almanak_rsi --once --dry-run

    # Run on Anvil fork
    almanak strat run -d almanak_rsi --network anvil --once

    # Run live (requires wallet config)
    almanak strat run -d almanak_rsi --once
...
if __name__ == "__main__":
    ...
    print("  almanak strat run -d almanak_rsi --once --dry-run")
