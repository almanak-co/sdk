"""Uniswap RSI Sweep Strategy Dashboard.
...
def render_custom_dashboard(
    ...
    """Render the Uniswap RSI Sweep custom dashboard."""
    st.title("Uniswap RSI Sweep Dashboard")
...
def _safe_get_ohlcv(
    ...
    *,
    ...
    to ``"USD"`` to match the upstream ``RSICalculator`` fetch.
    """
    try:
