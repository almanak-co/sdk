...
------
    # Run once
    almanak strat run -d aave_borrow --once

    # Run continuously
    almanak strat run -d aave_borrow --interval 60

    # Test on Anvil
    almanak strat run -d aave_borrow --network anvil --once
...
class AaveBorrowStrategy(IntentStrategy):
    ...
    def decide(self, market: MarketSnapshot) -> Intent | None:
        ...
        """
        # =================================================================
        # STEP 1: Handle force_action="supply" before price lookup
        # =================================================================
        # _create_supply_intent() does not need price data; guard here so that
        # smoke-tests on Anvil (which may lack price feeds) can still force supply.
        ...
        # =================================================================
        # STEP 2: Get current market prices (needed for borrow / state logic)
        # =================================================================
        ...
        try:
            ...
            logger.warning(f"Could not verify {self.collateral_token} balance")
            return Intent.hold(reason=f"Could not verify {self.collateral_token} balance")
...
if __name__ == "__main__":
    ...
    print("  almanak strat run -d aave_borrow --once")
    print("\nTo test on Anvil:")
    print("  almanak strat run -d aave_borrow --network anvil --once")
