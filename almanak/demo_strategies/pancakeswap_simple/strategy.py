...
if __name__ == "__main__":
    ...
    print(f"Supported Chains: {PancakeSwapSimpleStrategy.STRATEGY_METADATA.supported_chains}")
    print(f"Supported Protocols: {PancakeSwapSimpleStrategy.STRATEGY_METADATA.supported_protocols}")
    print("\nTo test on Anvil:")
