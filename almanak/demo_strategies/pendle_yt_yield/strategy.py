...
if __name__ == "__main__":
    ...
    print(f"Supported Chains: {PendleYTYieldStrategy.STRATEGY_METADATA.supported_chains}")
    print(f"Supported Protocols: {PendleYTYieldStrategy.STRATEGY_METADATA.supported_protocols}")
    print(f"Intent Types: {PendleYTYieldStrategy.STRATEGY_METADATA.intent_types}")
