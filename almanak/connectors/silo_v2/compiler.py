"""Connector-owned compiler for silo v2 lending intents."""
...
class SiloV2Compiler(BaseLendingCompiler):
    """Compile silo v2 lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"silo_v2"})
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_silo_v2(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_silo_v2(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_silo_v2(
