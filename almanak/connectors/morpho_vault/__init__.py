...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "UnsupportedVaultError": (".sdk", "UnsupportedVaultError"),
    "VAULT_VERSION_V1": (".sdk", "VAULT_VERSION_V1"),
    "VAULT_VERSION_V2": (".sdk", "VAULT_VERSION_V2"),
    "VaultGatedError": (".sdk", "VaultGatedError"),
    "VaultIlliquidError": (".sdk", "VaultIlliquidError"),
