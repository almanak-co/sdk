...
def _select_v3_pre_swap_router(compiler) -> tuple[str | None, str | None]:
    ...
    from almanak.connectors._strategy_base.protocol_aliases import is_uniswap_v3_fork
...
def _resolve_pendle_redeem_pt_address(compiler, adapter: Any, yt_address: str) -> str | None:
    ...
    from almanak.connectors.pendle.sdk import PT_TOKEN_INFO as _PT_TOKEN_INFO
    from almanak.connectors.pendle.sdk import YT_TOKEN_INFO as _YT_TOKEN_INFO
...
def compile_pendle_swap(compiler, intent: SwapIntent) -> CompilationResult:
    ...
    """
    from almanak.connectors.pendle import PendleAdapter, PendleSwapParams
...
def compile_pendle_lp_open(compiler, intent: LPOpenIntent) -> CompilationResult:
    ...
    try:
        ...
        from almanak.connectors.pendle import PendleLPParams
...
def compile_pendle_lp_close(compiler, intent: LPCloseIntent) -> CompilationResult:
    ...
    """
    from almanak.connectors.pendle import PendleAdapter, PendleLPParams
...
def compile_pendle_redeem(compiler, intent: WithdrawIntent) -> CompilationResult:
    ...
    """
    from almanak.connectors.pendle import PendleAdapter, PendleRedeemParams
