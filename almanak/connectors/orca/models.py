...
class OrcaPool:
    ...
    def from_api_response(cls, data: dict[str, Any]) -> OrcaPool:
        ...
        return cls(
            ...
            mint_a=data.get("tokenMintA", "") or token_a.get("address", "") or token_a.get("mint", ""),
            mint_b=data.get("tokenMintB", "") or token_b.get("address", "") or token_b.get("mint", ""),
            ...
            tvl=float(data.get("tvlUsdc", data.get("tvl", 0))),
            vault_a=data.get("tokenVaultA", "") or token_a.get("vault", ""),
            vault_b=data.get("tokenVaultB", "") or token_b.get("vault", ""),
