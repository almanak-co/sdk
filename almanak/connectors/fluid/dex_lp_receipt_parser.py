"""Back-compat shim: ``fluid.dex_lp_receipt_parser`` re-exports the shared implementation from
``almanak.connectors._fluid_core.dex_lp_receipt_parser`` (single source of truth).
"""
