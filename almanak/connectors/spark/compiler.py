"""Connector-owned compiler for spark lending intents."""
...
class SparkCompiler(BaseLendingCompiler):
    """Compile spark lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"spark"})
    chains: ClassVar[frozenset[str]] = frozenset(SPARK_POOL_ADDRESSES.keys())
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_spark(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_spark(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_spark(
