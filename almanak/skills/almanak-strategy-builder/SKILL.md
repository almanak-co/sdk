...
- **Percentage fields**: `total_return_pct`, `annualized_return_pct`, and `max_drawdown_pct` are actual percentages (33 = 33%). Ratio fields such as `win_rate` remain decimal fractions (0.33 = 33%).
