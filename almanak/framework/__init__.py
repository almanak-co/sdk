...
_LAZY_IMPORTS: dict[str, LazySpec] = {
    ...
    # VIB-4062: MarketSnapshot + DTOs resolve via the canonical
    # framework/market/ package, not strategies/.
    "MarketSnapshot": ".market",
    "MultiChainMarketSnapshot": ".market",
    "MarketSnapshotBuilder": ".market",
    "TokenBalance": ".market",
    "PriceData": ".market",
    "ReferencePriceData": ".market",
    "ReferencePriceBasis": ".market",
    "ReferencePriceCompositionData": ".market",
    "ReferenceMarketStatus": ".market",
    "MarketSessionData": ".market",
    "RSIData": ".market",
    "PriceOracle": ".market",
    "RSIProvider": ".market",
    "BalanceProvider": ".market",
    "MarketSnapshotError": ".market",
    "ILExposureUnavailableError": ".market",
    "ChainNotConfiguredError": ".market",
    "AmbiguousChainError": ".market",
