...
class CapabilitiesRegistry:
    ...
    _BUILTIN_LOADERS: ClassVar[dict[str, str]] = {
        # Lending — pooled
        "aave_v3": "almanak.framework.connectors.aave_v3.capabilities",
        "spark": "almanak.framework.connectors.spark.capabilities",
        "compound_v3": "almanak.framework.connectors.compound_v3.capabilities",
        "benqi": "almanak.framework.connectors.benqi.capabilities",
        "radiant_v2": "almanak.framework.connectors.radiant_v2.capabilities",
        "euler_v2": "almanak.framework.connectors.euler_v2.capabilities",
        # Lending — isolated markets
        "morpho": "almanak.framework.connectors.morpho_blue.capabilities",
        "morpho_blue": "almanak.framework.connectors.morpho_blue.capabilities",
        "curvance": "almanak.framework.connectors.curvance.capabilities",
        "silo_v2": "almanak.framework.connectors.silo_v2.capabilities",
        # Lending — Solana
        "kamino": "almanak.framework.connectors.kamino.capabilities",
        # Perps
        "gmx_v2": "almanak.framework.connectors.gmx_v2.capabilities",
        "hyperliquid": "almanak.framework.connectors.hyperliquid.capabilities",
        "drift": "almanak.framework.connectors.drift.capabilities",
        # Concentrated-liquidity / swap
        "uniswap_v3": "almanak.framework.connectors.uniswap_v3.capabilities",
        "enso": "almanak.framework.connectors.enso.capabilities",
        "pendle": "almanak.framework.connectors.pendle.capabilities",
        # ERC-4626 vaults
        "metamorpho": "almanak.framework.connectors.morpho_vault.capabilities",
        # Prediction markets
        "polymarket": "almanak.framework.connectors.polymarket.capabilities",
        # Solana LP
        "raydium_clmm": "almanak.framework.connectors.raydium.capabilities",
        "meteora_dlmm": "almanak.framework.connectors.meteora.capabilities",
        "orca_whirlpools": "almanak.framework.connectors.orca.capabilities",
    }
