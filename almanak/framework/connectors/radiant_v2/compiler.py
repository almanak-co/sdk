"""Connector-owned compiler for radiant v2 lending intents."""
...
class RadiantV2Compiler(BaseLendingCompiler):
    """Compile radiant v2 lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"radiant_v2"})
    chains: ClassVar[frozenset[str]] = frozenset({"ethereum", "arbitrum"})
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_aave_compatible(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_aave_compatible(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_aave_compatible(
