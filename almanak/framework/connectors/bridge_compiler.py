...
from almanak.framework.connectors.base.compiler import BaseBridgeCompiler, BaseCompilerContext
...
class BridgeCompiler(BaseBridgeCompiler):
    ...
    def _build_selector(self, ctx: BaseCompilerContext) -> BridgeSelector:
        from almanak.framework.connectors.across.adapter import AcrossBridgeAdapter
