"""Connector-owned compiler for compound v3 lending intents."""
...
class CompoundV3Compiler(BaseLendingCompiler):
    """Compile compound v3 lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"compound_v3"})
    chains: ClassVar[frozenset[str]] = frozenset(COMPOUND_V3_COMET_ADDRESSES.keys())
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_compound_v3(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_compound_v3(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_compound_v3(
