"""Connector-owned compiler for curvance lending intents."""
...
class CurvanceCompiler(BaseLendingCompiler):
    """Compile curvance lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"curvance"})
    chains: ClassVar[frozenset[str]] = frozenset({"monad"})
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_curvance(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_curvance(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_curvance(
