"""Connector-owned compiler for morpho blue lending intents."""
...
class MorphoBlueCompiler(BaseLendingCompiler):
    """Compile morpho blue lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"morpho", "morpho_blue"})
    chains: ClassVar[frozenset[str]] = frozenset(MORPHO_BLUE_ADDRESSES.keys())
    ...
    def compile_supply(self, ctx: BaseCompilerContext, intent: SupplyIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_supply_morpho_blue(adapter, intent, supply_token, amount_decimal)
    ...
    def compile_withdraw(self, ctx: BaseCompilerContext, intent: WithdrawIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_withdraw_morpho_blue(
    ...
    def compile_borrow(self, ctx: BaseCompilerContext, intent: BorrowIntent) -> CompilationResult:
        ...
        return _aave_helpers._compile_borrow_morpho_blue(
