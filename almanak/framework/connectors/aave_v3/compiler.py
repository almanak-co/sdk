"""Connector-owned compiler for aave v3 lending intents."""
...
class AaveV3Compiler(BaseLendingCompiler):
    """Compile aave v3 lending intents."""

    protocols: ClassVar[frozenset[str]] = frozenset({"aave_v3"})
    chains: ClassVar[frozenset[str]] = frozenset(AAVE_V3_POOL_ADDRESSES.keys())
