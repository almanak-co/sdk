...
from ..data.timeframes import OHLCVTimeframe
...
class IndicatorService(Protocol):
    def rsi(self, token: str, period: int, timeframe: OHLCVTimeframe, chain: str) -> RSIData: ...
    def sma(self, token: str, period: int, timeframe: OHLCVTimeframe, chain: str) -> MAData: ...
    def ema(self, token: str, period: int, timeframe: OHLCVTimeframe, chain: str) -> MAData: ...
    def macd(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> MACDData: ...
    def bollinger_bands(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> BollingerBandsData: ...
    def atr(self, token: str, period: int, timeframe: OHLCVTimeframe, chain: str) -> ATRData: ...
    def stochastic(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> StochasticData: ...
    def adx(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> ADXData: ...
    def cci(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> CCIData: ...
    def obv(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> OBVData: ...
    def ichimoku(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> IchimokuData: ...
...
class OHLCVService(Protocol):
    def ohlcv(self, token: str, timeframe: OHLCVTimeframe, chain: str) -> Any: ...
