...
# Maximum number of rounds to traverse in a single fetch operation
MAX_ROUNDS_TO_FETCH = 50000

# Progress logging interval (every N rounds)
ROUND_FETCH_PROGRESS_INTERVAL = 500

# Maximum binary search iterations for timestamp-to-round lookup
