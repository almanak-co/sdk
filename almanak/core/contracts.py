...
# Uniswap V4 contracts — addresses are DIFFERENT per chain (not same CREATE2).
# Source: https://docs.uniswap.org/contracts/v4/deployments (verified 2026-03-28).
# "Integrators should no longer assume that they are deployed to the same addresses across chains."
# See: VIB-1462 (original fabricated address bug where same address was copied to all chains).
