...
- **Soporte multi-cadena** - Ethereum, Arbitrum, Optimism, Base, Avalanche, Polygon, BSC, Sonic, Plasma, Blast, Linea, Mantle, Berachain, Solana, Monad, X-Layer, 0G Chain, HyperEVM, Robinhood.
- **Integración de protocolos** - Uniswap V3/V4, PancakeSwap V3, SushiSwap V3, TraderJoe V2, Aerodrome, Curve, Aave V3, Morpho Blue, GMX V2, Compound V3, Pendle, Spark, Lido, Ethena, Enso, LiFi, Kraken, y [20+ más](api/connectors/index.md). _(Los mercados de predicción (Polymarket) y los préstamos flash (Balancer) son experimentales y están temporalmente excluidos de la matriz de soporte hasta completar las pruebas.)_
