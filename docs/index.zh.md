...
- **多链支持** - Ethereum、Arbitrum、Optimism、Base、Avalanche、Polygon、BSC、Sonic、Plasma、Blast、Linea、Mantle、Berachain、Solana、Monad、X-Layer、0G Chain。
- **协议集成** - Uniswap V3/V4、PancakeSwap V3、SushiSwap V3、TraderJoe V2、Aerodrome、Curve、Balancer、Aave V3、Morpho Blue、GMX V2、Compound V3、Pendle、Radiant V2、Spark、Lido、Ethena、Enso、LiFi、Polymarket、Kraken 以及[另外 20+ 个](api/connectors/index.md)。
