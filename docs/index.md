...
- **Protocol Integration** - Uniswap V3/V4, PancakeSwap V3, SushiSwap V3, TraderJoe V2, Aerodrome, Curve, Balancer, Aave V3, Morpho Blue, GMX V2, Compound V3, Pendle, Radiant V2, Spark, Lido, Ethena, Enso, LiFi, Polymarket, Kraken, and [20+ more](api/connectors/index.md).
...
- **Agentic DeFAI Trading** - Build autonomous LLM-driven agents with 38 built-in tools, policy-enforced safety, and support for OpenAI, MCP, and LangChain.
