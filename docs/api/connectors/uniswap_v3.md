...
| Field | Value |
|-------|-------|
| Module | ``almanak.connectors.uniswap_v3`` |
| Protocol kind | LP |
...
|-------|--------|-------------------|
| [Arbitrum](../../chains/arbitrum.md) | EVM | ``LP_CLOSE``, ``LP_COLLECT_FEES``, ``LP_OPEN``, ``SWAP`` |
| [Avalanche](../../chains/avalanche.md) | EVM | ``LP_CLOSE``, ``LP_COLLECT_FEES``, ``LP_OPEN``, ``SWAP`` |
