...
USAGE:
------
    almanak strat run -d strategies/demo/ethena_pt_leverage --fresh --once --network anvil
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(f"\nStrategy: {EthenaPTLeverageStrategy.STRATEGY_NAME}")
    print(f"Chains: {EthenaPTLeverageStrategy.SUPPORTED_CHAINS}")
    print(f"Protocols: {EthenaPTLeverageStrategy.SUPPORTED_PROTOCOLS}")
    print(f"Intents: {EthenaPTLeverageStrategy.INTENT_TYPES}")
