...
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py

# Parameter sweep (tests 63 configurations)
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --sweep

# Custom capital and period
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --capital 10000 --days 180
```
...
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --days 90

# Full parameter sweep (63 configs, ~5 seconds)
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --sweep

# Test at $10k scale
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --capital 10000 --days 90

# Save results to JSON
uv run python strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/backtest.py --sweep --output results.json
```
...
```
strategies/xlayer/xlayer-strategy-backup/xlayer_deterministic/aave_okb_clmm_loop/
  README.md       # this file
  __init__.py
...
- **Edge spec**: `playground/xlayer/aave-uniswap/specs.md` (ID cmnt8k6v2005saopppn2hx9bx)
