...
def fund_wallet_with_usdc(wallet: str, amount_usdc: int) -> bool:
    ...
    try:
        ...
        if whale_balance < amount_wei:
            print(f"WARNING: Whale has insufficient USDC")
            return False
...
def test_swap() -> dict | None:
    ...
    try:
        ...
        if parse_result.success:
            ...
            if swap_amounts:
                print(f"   Extracted swap amounts:")
...
def main():
    ...
    # Redact API key from fork URL for logging
    print(f"Fork URL: https://arb-mainnet.g.alchemy.com/v2/...[REDACTED]")
