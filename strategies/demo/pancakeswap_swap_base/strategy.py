"""PancakeSwap V3 Swap Lifecycle on Base.

Two-phase swap strategy testing PancakeSwap V3 on Base (4th chain after BSC,
Arbitrum, Ethereum).
...
Validates swap compilation, execution, receipt parsing, and enrichment
on Base where the SmartRouter is configured but never tested.

Kitchen Loop iter 137 -- VIB-2013
"""
...
@almanak_strategy(
    name="demo_pancakeswap_swap_base",
    description="PancakeSwap V3 swap lifecycle (BUY/SELL) on Base",
    version="1.0.0",
    author="Almanak",
    tags=["demo", "pancakeswap", "swap", "base", "lifecycle"],
...
class PancakeSwapV3SwapBaseStrategy(IntentStrategy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        logger.info(
            f"PancakeSwapV3SwapBaseStrategy: force_action={self.force_action}, "
